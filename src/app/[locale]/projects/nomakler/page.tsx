...
import { ArrowLeft, ArrowUpRight, Globe, ShieldCheck, Home, CheckCircle2 } from "lucide-react";

export default function NoMaklerProjectPage() {
  const t = useTranslations("NoMaklerDetail");
      ...
      <main className="flex-1 pt-28 sm:pt-36 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4">
            ...
            {/* CTA Button: Live Website */}
            <div className="pt-2 pb-2">
              <a
                href="https://nomakler.uz/"
                target="_blank"
          ...
          {/* Video Showcase Section (Right before footer, as requested) */}
          <div className="mt-16 sm:mt-24 space-y-6 border-t border-zinc-200/80 dark:border-zinc-800/80 pt-12">
            <div>
            ...
            <div className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden border border-zinc-200/90 dark:border-zinc-800/90 bg-zinc-950 shadow-xl dark:shadow-2xl">
              <video
                ...
                controls
                preload="auto"
                poster="/images/nomakler.png"
                className="w-full h-auto aspect-video object-cover"
              >
                <source src="/videos/nomakler.mp4" type="video/mp4" />
